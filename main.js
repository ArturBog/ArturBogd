...
const listsConfig = [
  ...
  { id: 'in-progress', title: 'В процессе', tasks: ['Задача 1', 'Задача 1'] },
  { id: 'done', title: 'Готово', tasks: ['Задача 1', 'Задача 2']},
  { id: 'trash', title: 'Корзина', tasks: ['Задача 1', 'Задача 2'], hasClearButton: true }
];
